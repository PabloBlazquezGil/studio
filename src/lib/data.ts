...
export const projects: Project[] = [
  ...
  { id: '9', title: 'Día de la Mujer y la Niña en la Ciencia', category: 'Divulgación Científica', year: 2024, client: 'Centro de Astrobiología (CAB, CSIC-INTA)', imageUrl: 'https://images.unsplash.com/photo-1614926120485-0c5897f11e8?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3', description: 'Un vídeo conmemorativo para el Centro de Astrobiología con motivo del Día Internacional de la Mujer y la Niña en la Ciencia, buscando inspirar a nuevas generaciones y visibilizar el papel de las mujeres en la investigación espacial.', media: [{ type: 'video', url: 'https://thundershoot.com/wp-content/uploads/2024/11/Dia-de-la-Mujer-y-la-Nina-en-la-Ciencia-11_02_2024-Centro-de-Astrobiologia-CAB-CSIC-INTA.mp4' }, {type: 'image', url: 'https://images.unsplash.com/photo-1614926120485-0c5897f11e8?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3'}] },
];
